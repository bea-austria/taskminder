            ...
            <main>
                <section className="relative flex-grow md:grid md:grid-cols-2 bg-blue-900">
                    ...
                    <div className="relative p-6 pb-0 xsm:p-8 xsm:pb-0 sm:p-12 sm:pb-0 md:p-10 lg:p-12 ">
                        ...
                        <p className='text-base text-white sm:text-lg md:text-lg lg:text-xl lg:my-6' style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 1.5)' }}>This remote employee productivity tracker is a comprehensive tool designed to monitor and enhance the productivity of remote employees. This tool ensures accountability and helps maintain productivity in a remote working environment.</p>
                        <a href="#about">
