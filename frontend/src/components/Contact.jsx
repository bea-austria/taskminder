function Contact(){
    return(
        <section className="lg:grid lg:grid-cols-2 p-6">
            <div className="bg-white dark:bg-gray-900">
                <div className="py-3 px-4 mx-auto max-w-screen-xl lg:py-5 lg:px-6">
                    <div className="mx-auto max-w-screen-md sm:text-center">
                        <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 sm:text-2xl dark:text-white">Sign up for our newsletter</h2>
            ...
            <div className="md:grid md:grid-cols-4 md:gap-8 lg:gap-6 lg:items-start px-6 lg:py-2 mt-4 lg:mt-0">
                ...
                <div>
                    ...
                    <p className="leading-relaxed">taskminder_help</p>
                    <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">TWITTER</h2>
                    <p className="leading-relaxed">taskminder_tweets</p>    
                </div>
                <div>
                    <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">PRIVACY POLICY</h2>
                    <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">HELP CENTER</h2>
                    <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">TERMS</h2>
                </div>
                <div>
