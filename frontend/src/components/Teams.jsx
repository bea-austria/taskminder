        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                    ...
                    <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">A dynamic team of digital marketing experts strategizing, executing, and optimizing campaigns to maximize online presence and drive engagement.</p>
                </div> 
