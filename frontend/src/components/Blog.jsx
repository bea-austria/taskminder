        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center lg:mb-12 mb-5">
                    <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-blue-900 dark:text-white">Our Blog</h2>
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                    {blogs.map((blog)=>(
                        <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <span className="text-sm text-blue-900">{blog.date}</span>
                            <h2 className="mb-2 mt-3 text-xl sm:text-2xl font-bold tracking-tight text-blue-900 dark:text-white"><a href="#">{blog.title}</a></h2>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span class="material-symbols-outlined text-lg ml-2 text-blue-900">
                                        arrow_forward
                                    </span>
                                </div>
                            </div>
